...
(function () {
  ...
  // Additional demo variations so menus don't feel identical every time
  const DEMO_MENU_WOD_VARIANTS = [
    DEMO_MENU_WOD,
    {
      dayType: 'wod',
      totalCalories: 2450,
      meals: [
        {
          ...
          macros: { protein: 24, carbs: 54, fat: 20 },
          fuelStory: 'This is a handheld carb and protein bomb that travels well. Eggs and sweet potato keep you fueled through long WODs without a sugar spike.',
          impactCopy: 'You can eat this at 7am and still feel steady at noon. The wrap is your portable glycogen reload, the sweet potato keeps your engine humming, and the fat keeps you from crashing.'
        },
        {
          mealType: 'lunch',
          ...
          macros: { protein: 38, carbs: 50, fat: 16 },
          fuelStory: 'Lean turkey for repair, rice for refuel, greens for volume and micronutrients. Big bowl energy without the bloat.',
          impactCopy: 'This bowl hits like a refill notification for your legs. You walk away full but light, not food-coma heavy, and your afternoon still belongs to you.'
        },
        {
          mealType: 'dinner',
          dishName: 'Shrimp Stir-Fry with Jasmine Rice',
          ingredients: ['shrimp', 'jasmine rice', 'snap peas', 'carrots', 'soy sauce', 'sesame oil'],
          macros: { protein: 32, carbs: 56, fat: 14 },
          fuelStory: 'Quick-cooking shrimp means dinner is fast and light. Plenty of carbs to top off stores before tomorrow\'s work.',
          impactCopy: 'You could eat this an hour before bed and still feel light. Shrimp gives you clean protein, the rice tops off glycogen, and the veggies keep your system moving.'
        },
        {
          mealType: 'snack',
          dishName: 'Cottage Cheese Bowl with Pineapple & Seeds',
          ingredients: ['cottage cheese', 'pineapple', 'pumpkin seeds', 'chia seeds'],
          macros: { protein: 22, carbs: 24, fat: 10 },
          fuelStory: 'Slow-digesting protein with a bit of fruit sugar. Perfect for late-night recovery or that post-WOD hunger window.',
          impactCopy: 'This is your quiet recovery snack. Casein drips amino acids into your muscles while you answer emails or sleep; the pineapple keeps it from feeling like a chore.'
        }
      ]
    },
    {
      ...
      meals: [
        {
          mealType: 'breakfast',
          dishName: 'Protein Pancakes with Berries',
          ingredients: ['oat flour', 'egg whites', 'Greek yogurt', 'mixed berries', 'maple syrup'],
          macros: { protein: 26, carbs: 60, fat: 8 },
          fuelStory: 'Feels like brunch, performs like fuel. High protein, plenty of carbs, minimal junk.',
          impactCopy: 'You get the pancake vibes without the carb coma. Your muscles see amino acids and glycogen; your brain just sees pancakes.'
        },
        {
          mealType: 'lunch',
          ...
          impactCopy: 'Every bite is omega-3s and complex carbs teaming up so tomorrow doesn\'t hurt as much. Farro keeps you full, salmon keeps you training.'
        },
        {
          mealType: 'dinner',
          dishName: 'Chicken Fajita Plate with Peppers & Rice',
          ingredients: ['chicken breast', 'bell peppers', 'onion', 'rice', 'spices', 'lime'],
          macros: { protein: 40, carbs: 52, fat: 10 },
          fuelStory: 'Big flavors, simple macros: a plate that hits your craving for “real food” while still fueling tomorrow.',
          impactCopy: 'You could serve this to non-CrossFit friends and they\'d just call it a great dinner. Under the hood it\'s lean protein and carbs tuned for performance.'
        },
        {
          mealType: 'snack',
          dishName: 'Rice Cakes with Peanut Butter & Banana',
          ingredients: ['rice cakes', 'peanut butter', 'banana'],
          macros: { protein: 12, carbs: 32, fat: 12 },
          fuelStory: 'A classic pre-WOD combo: quick carbs plus a little fat. Easy on the stomach, big on usable energy.',
          impactCopy: 'This is the snack you eat 60 minutes before the clock starts so you\'re not thinking about food mid-WOD. It\'s rocket fuel in three ingredients.'
        }
      ]
    }
  ];

  const DEMO_MENU_REST_VARIANTS = [
    DEMO_MENU_REST,
    {
      dayType: 'rest',
      totalCalories: 1950,
      meals: [
        {
          ...
          macros: { protein: 24, carbs: 26, fat: 18 },
          fuelStory: 'High protein, moderate carbs, healthy fats. Perfect for a slower morning when you\'re not rushing to the box.',
          impactCopy: 'This is a bowl that keeps you from hunting snacks an hour later. Your muscles get a steady trickle of aminos while the fats keep you satisfied.'
        },
        {
          mealType: 'lunch',
          dishName: 'Quinoa & Roasted Veggie Plate',
          ingredients: ['quinoa', 'zucchini', 'eggplant', 'bell peppers', 'olive oil', 'herbs'],
          macros: { protein: 18, carbs: 40, fat: 20 },
          fuelStory: 'Color on a plate plus plant protein. Fiber and volume without a blood sugar rollercoaster.',
          impactCopy: 'This is the kind of lunch that leaves you clear-headed instead of sleepy. Your gut is happy, your joints are happy, and your macros still make sense.'
        },
        {
          mealType: 'dinner',
          ...
          macros: { protein: 36, carbs: 28, fat: 20 },
          fuelStory: 'A cozy, higher-fat meal for a lower-output day. Plenty of protein for repair without excessive carbs.',
          impactCopy: 'You get comfort food without blowing your rest-day calories. The fat keeps you satisfied; the protein keeps you progressing.'
        },
        {
          mealType: 'snack',
          dishName: 'Carrot Sticks with Hummus',
          ingredients: ['carrots', 'hummus', 'paprika'],
          macros: { protein: 6, carbs: 18, fat: 8 },
          fuelStory: 'Crisp, crunchy, and light. Enough to kill cravings without turning into a second lunch.',
          impactCopy: 'This is the snack that keeps “just one handful of chips” from turning into the bag. Fiber, a bit of protein, and a lot of crunch.'
        }
      ]
    },
    {
      ...
      meals: [
        {
          ...
          macros: { protein: 26, carbs: 10, fat: 24 },
          fuelStory: 'Low-carb, high-satiety breakfast that leans into protein and fat on your easier day.',
          impactCopy: 'This omelette buys you hours of focus. You feel fed, not foggy, and your blood sugar stays boring in the best way.'
        },
        {
          mealType: 'lunch',
          dishName: 'Tuna Salad Lettuce Wraps',
          ingredients: ['canned tuna', 'Greek yogurt', 'celery', 'lettuce', 'lemon', 'mustard'],
          macros: { protein: 30, carbs: 8, fat: 10 },
          fuelStory: 'High protein without the bread. Crunchy, salty, and light enough for a walk after.',
          impactCopy: 'This is the lunch that makes you feel like a machine, not a couch ornament. Tons of protein, almost no fluff.'
        },
        {
          mealType: 'dinner',
          dishName: 'Lentil Soup with Greens',
          ingredients: ['lentils', 'spinach', 'carrots', 'onion', 'vegetable broth', 'olive oil'],
          macros: { protein: 24, carbs: 34, fat: 10 },
          fuelStory: 'Warm, slow, and grounding. Lentils bring plant protein and fiber that fits perfectly into a recovery day.',
          impactCopy: 'This bowl feels like hitting the brakes in the best way. Your nervous system and your digestion both get the memo: we\'re off-duty today.'
        },
        {
          mealType: 'snack',
          dishName: 'Dark Chocolate & Almonds',
          ingredients: ['dark chocolate', 'almonds'],
          macros: { protein: 6, carbs: 16, fat: 14 },
          ...
          impactCopy: 'You get the satisfaction of dessert without turning your rest day into a cheat day. Tiny portion, big psychological win.'
        }
      ]
    }
  ];

  function pickDemoMenu(dayType) {
    const pool = dayType === 'wod' ? DEMO_MENU_WOD_VARIANTS : DEMO_MENU_REST_VARIANTS;
    const base = pool[Math.floor(Math.random() * pool.length)];
    // Shallow clone is enough; we only ever tweak totalCalories
    return { ...base, meals: base.meals.map(m => ({ ...m, ingredients: [...m.ingredients] })) };
  }
  ...
  async function generateMenu() {
    ...
    try {
      ...
      if (!menuData) {
        menuData = pickDemoMenu(selectedDay);
